module.exports = (function() {
  ...
  return {
    ...
    getCampaignMedium: function (landinguri, campcode, refuri) {
    ...
    track: function(currentUrl, referrerUrl) {

      var params = parseUri(currentUrl).queryKey,
      ...
      if (params.query != "" && !params.gclid) {
        ...
        if (params.affil) {
          ...
          var campmedium = getCampaignMedium(currentUrl, params.affil, referrerUrl);
          ...
          return { 'dimension11': params.affil };
        }
